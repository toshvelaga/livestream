...
const updateDbFacebookValues = async (
  ...
  let results = await pool.query(
	...
	VALUES($1, $2) ON CONFLICT (user_id) DO UPDATE SET facebook_access_token = EXCLUDED.facebook_access_token, facebook_long_access_token = EXCLUDED.facebook_long_access_token`,
