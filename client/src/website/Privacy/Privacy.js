...
function Privacy() {
  return (
    <div className='privacy-container'>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Ohmystream, 1272 Morgan Marie Street.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Ohmystream, accessible from{' '}
            <a
              href='https://www.ohmystream.co'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://www.ohmystream.co
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: toshvelaga@gmail.com</li>
      </ul>
    </div>
  )
}
